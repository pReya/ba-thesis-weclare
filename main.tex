...
\babelhyphenation[ngerman]{Down-load}
...
Außerdem können Java-Quelltexte, die in die Fragestellungen eingebettet werden, unmittelbar \textbf{im Browser ausgeführt werden}. Dazu wird eine Java-Virtual-Machine (implementiert in JavaScript) im Browser ausgeführt.}
